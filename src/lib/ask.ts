...
Answer the QUESTION using only what CONTEXT actually supports. If the answer isn't in CONTEXT, say you don't know rather than guessing. Do not describe or summarize what CONTEXT contains, and do not comment on confusion or mixed-up conversations — just answer the question directly and concisely, in at most two sentences.`;
